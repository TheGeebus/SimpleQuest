 ...
 *
 *   ResolutionTimestamp - quest time (UQuestStateSubsystem::GetQuestTime) at the originating SetQuestResolved call. Per-tick stable
...
struct SIMPLEQUEST_API FOriginatingEventID
{
    ...
    /** Quest time at the originating SetQuestResolved call. Per-tick stable; distinguishes re-firings across ticks. */
    UPROPERTY(BlueprintReadOnly, SaveGame)
