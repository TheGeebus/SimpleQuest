...
public:
	...
	/** The single file this format emits. One definition, so the writer and reader cannot disagree about the name. */
	static FString BundleFileName() { return TEXT("questline.json"); }
};