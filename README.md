...
| Q3 2026 | Save/Load system — `USaveGame` integration with mid-step state handling | **Shipped** (v0.5.0) |
| Q4 2026 | Rewards at objective parity — first-class, instance-based reward nodes (triggerable and targetable) symmetric with the objective pipeline | Planned (v0.6.0) |
| Q1 2027 | Universal adapter completion + expanded objective library — objective deactivation hook paired with timer, world-state-fact, and composite reference objectives, plus a systems-integration guide | Planned (v0.7.0) |
