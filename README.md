...
| Q3 2026  | Driving it from outside — resolver export, plan, and apply on the public module API for programmatic and tool-driven authoring; advancement holds so presentation can pace quest flow; reusable reward set assets                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | **In Development** (v0.8.0)        |
